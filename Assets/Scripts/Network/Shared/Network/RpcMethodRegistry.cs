...
#else
                System.Console.WriteLine($"[RPC] Duplicate method hash: 0x{methodHash:X}. Possible hash collision!");
#endif
            }
        }
...
#else
                System.Console.WriteLine($"[RPC] No handler registered for method hash: 0x{methodHash:X}");
#endif
            }
        }
