    ...
    public static class HeroRegistry
    {
        ...
        public static void Initialize()
        {
            ...
            _heroes = new Dictionary<int, HeroConfig>
            {
                ...
                [1] = new HeroConfig
                {
                    HeroId = 1, Name = "Soldier", MaxHP = 100,
                ...
                // Tank: high HP, slow, large
                [2] = new HeroConfig
                {
                    HeroId = 2, Name = "Tank", MaxHP = 200,
                ...
                // Sniper: low HP, fast, small
                [3] = new HeroConfig
                {
                    HeroId = 3, Name = "Sniper", MaxHP = 75,
        ...
        // --- Hero-specific ability factories ---
